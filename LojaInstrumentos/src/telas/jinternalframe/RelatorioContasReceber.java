...
import listener.RelatorioContasReceberListener;

public class RelatorioContasReceber extends javax.swing.JInternalFrame {
    private RelatorioContasReceberListener listener = new RelatorioContasReceberListener(this);
    /**
    ...
    private void initComponents() {
        ...
        PainelRelatorioContasReceber.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("RelatorioContasReceber.PainelRelatorioContasReceber.border.title"))); // NOI18N
        ...
        if (TabelaRelatorio.getColumnModel().getColumnCount() > 0) {
            TabelaRelatorio.getColumnModel().getColumn(0).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title0")); // NOI18N
            TabelaRelatorio.getColumnModel().getColumn(1).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title1")); // NOI18N
            TabelaRelatorio.getColumnModel().getColumn(2).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title2")); // NOI18N
            TabelaRelatorio.getColumnModel().getColumn(3).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title3")); // NOI18N
            TabelaRelatorio.getColumnModel().getColumn(4).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title4")); // NOI18N
            TabelaRelatorio.getColumnModel().getColumn(5).setHeaderValue(bundle.getString("RelatorioContasReceber.TabelaRelatorio.columnModel.title5")); // NOI18N
        }

        BotaoOK.setText(bundle.getString("RelatorioContasReceber.BotaoOK.text")); // NOI18N
        BotaoOK.addActionListener(listener);
        BotaoOK.setActionCommand("ok");
        BotaoCancelar.setText(bundle.getString("RelatorioContasReceber.BotaoCancelar.text")); // NOI18N
